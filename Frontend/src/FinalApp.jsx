...
// -----------------------
// Interview Chat Component (Header includes round selection and listening indicator)
// -----------------------
    ...
    <div className="min-h-screen bg-[#A9B5DF] flex flex-col">
      <header className="bg-white shadow-xl rounded-lg p-4 flex items-center justify-between">
        <div className="flex items-center">
          <h1 className="text-3xl font-bold text-gray-800 mr-6">Interview Mentor</h1>
        ...
        <div className="flex items-center space-x-4">
          ...
          {listening && (
            <div className="px-2 py-1 bg-green-500 text-white rounded text-sm">
              Listening
            </div>
          )}
          <button
      ...
      <div className="w-1/2 h-screen mx-auto p-4 flex flex-col">
        <div ref={chatboxRef} className="bg-gray-50 border border-gray-200 rounded-lg p-4 flex-1 overflow-y-auto mb-4">
